...
export default function OrderTest() {
  ...
  const isAllSelected = () => {
    return (
      ...
      selectedItems.size ===
        (filteredData.length > 0 ? filteredData.length : listdatas.length)
    );
  };
    ...
    <div className="list-table-root flex flex-col p-6">
      ...
      <div className="flex-col text-white OrderBasket">
                    ...
                    <TableRow key={detail.itemsId}>
                      ...
                      <TableCell align="center">
                        <TextField
                          ...
                          onChange={(e) =>
                            handleQuantityChange(detail.itemsId, e.target.value)
                          }
                      ...
                      >
                        <IconButton
                          onClick={() => handledeleteitem(detail.cartItemId)}
                          size="small"
                          sx={{ color: "white" }}
                        >
        ...
        <div className="flex justify-end my-5">
          <Button className="bluebutton2" onClick={handlePurchaseButtonClick}>
            구매신청
          </Button>
          <Modal2
            open={perchaseopen}
